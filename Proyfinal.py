...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://fondosmil.com/fondo/51301.jpg");
...
tabs = st.tabs(['_Datos_','Marcas','Tipo de tracción','Tipo de clima','Predicción clima frío','Predicción clima cálido'])
tab_plots= tabs[0]
with tab_plots:
